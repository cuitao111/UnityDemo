...
namespace Gamekit2D
{
    ...
    {
        [Serializable]
        public class HealthEvent : UnityEvent<Damageable>   //Invoke函数参数必须传递Dmageable
        { }
        ...
        public int startingHealth = 5;                  //初始血量
        public bool invulnerableAfterDamage = true;     //被击后无敌标识
        public float invulnerabilityDuration = 3f;      //被击无敌持续时间
        public bool disableOnDeath = false;             //禁用死亡标识
        //对象位置的偏移量，用于设置从何处计算到损坏的距离
