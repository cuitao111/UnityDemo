...
namespace Gamekit2D
{
    ...
    {
        [Serializable]
        public class DamagableEvent : UnityEvent<Damager, Damageable>    //Damageable中也会有一个类似的类
        { }
        ...
        //从 onDamageableHIt 或 OnNonDamageableHit 内部调用它以获取被击中的内容。 玩家被击中？子弹击中敌人？
