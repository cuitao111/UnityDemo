...
namespace Gamekit2D
{
    public class PlayerInput : InputComponent, IDataPersister
    {
        ...
        public InputButton Grab = new InputButton(KeyCode.I, XboxControllerButtons.RightBumper);
        public InputButton Dash = new InputButton(KeyCode.L, XboxControllerButtons.LeftBumper);
        ...
        protected override void GetInputs(bool fixedUpdateHappened)
        {
            ...
            Grab.Get(fixedUpdateHappened, inputType);
        ...
        public override void ReleaseControl(bool resetValues = true)
        {
            ...
            ReleaseControl(Grab, resetValues);
